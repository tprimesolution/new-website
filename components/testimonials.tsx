      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
        ...
        <div>
          ...
          <div className="flex justify-center pb-12 max-md:hidden md:pb-16">
            <div className="relative inline-flex flex-wrap justify-center rounded-[1.25rem] bg-gray-800/40 p-1">
              ...
              >
                ...
                <span>Monitoring & Platform Reliability</span>
              </button>
              {/* Button #5 */}
              <button
              ...
              >
                ...
                <span>Containerization Solution</span>
              </button>
            </div>
          </div>
          ...
          <div
            ...
            // className="mx-auto grid max-w-sm items-start gap-4 sm:max-w-sm sm:grid-cols-2 lg:grid-cols-3"
            className="mx-auto grid max-w-sm items-start gap-7 sm:max-w-none sm:grid-cols-2 lg:grid-cols-3"
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <div>
          <Image src={testimonial.clientImg} height={90} alt="Client logo" />
        </div>
